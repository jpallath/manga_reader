...
export const NavigationPane: React.FC<NavigationProps> = ({
  isOpen,
  onClose,
  triggerNav,
}) => {
  ...
  return (
    <div
      ...
      className={`absolute w-2/6 h-full transition-all flex items-center justify-center  bg-background z-10 
        ${
          isOpen
            ? "left-0 opacity-85 border-r-secondary border-r-2 rounded-r-sm"
    ...
    >
      ...
      <div
        ...
        className={`bg-primary py-4 px-4 text-xs m-2 rounded-xl border-secondary border-4 hover:border-primary hover:bg-secondary transition-all text-text hover:text-background absolute bottom-4 group cursor-pointer flex justify-between items-center gap-2 ${
      ...
      >
        ...
        <p className="block">Login / Register</p>
      </div>
      <div
        onClick={() => signOut()}
        className={`bg-primary py-4 px-4 text-xs m-2 rounded-xl border-secondary border-4 hover:border-primary hover:bg-secondary transition-all text-text hover:text-background absolute bottom-32 group cursor-pointer flex justify-between items-center gap-2 ${
          isOpen ? "opacity-1" : "opacity-0"
        }`}
      >
        <svg
